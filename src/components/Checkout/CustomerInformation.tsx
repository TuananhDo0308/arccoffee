        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={setCity}
              disabled={!region}
              className="w-full bg-zinc-800 border border-zinc-700 rounded-md p-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <option value="">Chọn thành phố</option>
              {cityOptions.map((option) => (
                <option key={option.id} value={option.id}>
